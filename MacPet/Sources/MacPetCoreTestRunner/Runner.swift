...
enum MacPetCoreTestRunner {
    static func main() async {
        let tests: [(String, () async throws -> Void)] = [
            ...
            ("reportsElapsedWhileFocusing", FocusClockSuite.reportsElapsedWhileFocusing),
            ("formatsElapsedDescription", FocusClockSuite.formatsElapsedDescription),
            ...
            ("stoppingTwentyFiveMinuteFocusGrantsOneFood", PetRuntimeSuite.stoppingTwentyFiveMinuteFocusGrantsOneFood),
            ("stoppingFourMinuteFocusGrantsNothing", PetRuntimeSuite.stoppingFourMinuteFocusGrantsNothing),
            ("focusDurationTextOnlyWhileFocusing", PetRuntimeSuite.focusDurationTextOnlyWhileFocusing),
